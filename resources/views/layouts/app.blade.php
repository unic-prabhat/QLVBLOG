...
<script type="text/javascript">
  window.location = "{{URL::to('/manager')}}";
</script>
@endif
@endguest
...
<html lang="en">
   ...
   <head>
      ...
      <link href="{{URL::to('/public/assets/css/bootstrap-multiselect.css')}}" rel="stylesheet" type="text/css" />
 ...
 .material-icons {
  ...
  border-bottom: 1px solid #e4e5e6;
   ...
   <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white dark-sidebar-color logo-dark">
      ...
      <script src="{{URL::to('/public/assets/js/bootstrap-multiselect.js')}}" ></script>
