    ...
    <div class="col-md-6">
      <div class="card card-box">
                                ...
                                <div class="card-body " id="bar-parent">
                                    <form action="{{URL::to('/productcategory')}}" method="post">
                                      @csrf
                                        ...
                                        <div class="card-body ">
                                            <div class="table-scrollable">
                                                <table class="table table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                      @foreach(App\Models\ProductCategory::all()->sortByDesc('id') as $key=>$data)
                                                        <tr>
                                                            <td>{{$key+1}}</td>
                                                            <td>{{$data->name}}</td>
                                                            <td>
                                                              ...
                                                              &nbsp;&nbsp;
                                                              <a href="{{URL::to('/productcategory/'.$data->id)}}" onclick="return confirm('Are you sure?');" class="btn btn-danger btn-sm">Delete</a>
