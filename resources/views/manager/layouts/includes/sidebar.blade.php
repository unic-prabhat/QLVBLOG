<div class="sidemenu-container navbar-collapse collapse fixed-menu">
   <div id="remove-scroll">
      <ul class="sidemenu  page-header-fixed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
         ...
         <li class="nav-item">
            <a href="{{URL::to('/manager')}}" class="nav-link nav-toggle">
            <span class="title"><i class="fa fa-tachometer" aria-hidden="true"></i> Dashboard</span>
            </a>
         </li>
         <li class="nav-item">
            <a href="{{URL::to('/manager/products')}}" class="nav-link nav-toggle">
            <span class="title"><i class="fa fa-gift" aria-hidden="true"></i> Products</span>
            </a>
         </li>

         <li class="nav-item">
            <a href="{{URL::to('/manager/orders')}}" class="nav-link nav-toggle">
            <span class="title"><i class="fa fa-cart-plus" aria-hidden="true"></i> Order <span class="badge badge-primary"></span></span>
            </a>
         </li>

         <li class="nav-item">
            <a href="#ex1" rel="modal:open" class="nav-link nav-toggle">
            <span class="title"><i class="fa fa-cart-plus" aria-hidden="true"></i> Reset Password <span class="badge badge-primary"></span></span>
            </a>
         </li>
